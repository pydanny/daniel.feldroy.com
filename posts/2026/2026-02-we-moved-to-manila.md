---
date: '2026-02-03T06:41:22.863302+00:00'
description: We're going to be in Metro Manila, Philippines for a while, here's some
  of the details.
published: true
tags:
- travel
...
In [Makati](https://en.wikipedia.org/wiki/Makati), a city that contains one of the major business districts in Metro Manila. Specifically we're in Salcedo village, a neighboorhood in the [CBD](https://en.wikipedia.org/wiki/Makati_Central_Business_District), made of towering residential and business buildings with numerous shops, markets, and a few parks. This area allows for a walkable life, which is important to us coming from London.
...
We loved living in London, and have many good friends there. I really enjoyed working for [Kraken Tech](https://kraken.tech/), but my time came to an end there so our visas were no longer valid. We hope to visit the UK (and the rest of Europe) as tourists, but without the family connection it's harder to justify than trips to the homeland.
...
- We're long-time members of the [Python Philippines](https://python.ph/) community, so you can often find us at their events
- If you train in BJJ, I'm usually at [Open Mat Makati](https://www.openmatmakati.com/) quite a bit. Just let me know ahead of time so I can plan around it
